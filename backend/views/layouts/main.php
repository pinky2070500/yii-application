...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
            ...
            <div class="sidebar-brand-text mx-3">WEBGIS RANH THỬA</div>
        </a>
...
<!--        </li>-->
        ...
        <!-- Nav Item - Charts -->
<!--        <li class="nav-item">-->
<!--            <a class="nav-link" href="--><?php //echo Url::to('zui/index')?><!--">-->
<!--                <i class="fas fa-fw fa-chart-area"></i>-->
<!--                <span>Charts</span></a>-->
<!--        </li>-->
        <!-- Nav Item - map -->
        <li class="nav-item">
            <a class="nav-link" href="<?php echo Url::to('/site/map')?>">
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link" href="<?php echo Url::to('/ranhthua/index')?>">
                <i class="fas fa-fw fa-table"></i>
                <span>Quản lý ranh thửa</span></a>
        </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="https://cdn-icons-png.flaticon.com/512/147/147142.png"
                                         alt="...">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="https://cdn3.iconfinder.com/data/icons/business-avatar-1/512/3_avatar-512.png"
                                         alt="...">
